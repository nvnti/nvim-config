...
local customs = require('functions.telescope_find')
local custom_term_toggles = require('functions.commands')
local custom_toggles = require('functions.toggles')
...
vim.keymap.set("n", "<space>gb", ":BlameToggle<CR>")

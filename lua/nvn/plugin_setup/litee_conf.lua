...
function M.fn()
  ...
  vim.api.nvim_set_keymap("n", "<SPACE>li",
    "<cmd>lua require('litee.lib.lsp.wrappers').buf_incoming_calls()<CR>:LTPopOutCalltree<CR>", opts)
  vim.api.nvim_set_keymap("n", "<SPACE>lo",
    "<cmd>lua require('litee.lib.lsp.wrappers').buf_outgoing_calls()<CR>:LTPopOutCalltree<CR>", opts)
end
